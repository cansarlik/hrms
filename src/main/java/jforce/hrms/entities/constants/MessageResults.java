package jforce.hrms.entities.constants;
...
public class MessageResults {
    ...
    static {
        ...
        models.put("staff", "Yetkili");
        models.put("company", "Proje Şirketi");
        models.put("employee", "Çalışan");
        models.put("title", "İş Başlığı");
        models.put("office", "Ofis");
        models.put("workingTime", "Çalışma Şekli");
        models.put("projectAnnounce", "Proje Duyurusu");
        models.put("favoriteProject", "Favori Proje");
        models.put("information", "Bilgileri");
        models.put("inventories", "Envanteri");
        models.put("projectExperience", "Proje tecrübesi");
    ...
    public static final String projectAddedFavorite = "Proje Duyurusu favorilere eklendi.";
    public static final String projectRemovedFavorite = "Proje Duyurusu favorilerden kaldırıldı.";
